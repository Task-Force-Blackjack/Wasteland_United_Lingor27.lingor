...
switch(_selectedBox) do {
    ...
    case "basicUS2": { // Basic US 2 is a few M4's and some combat shotguns
		...
		_currBox addWeaponCargoGlobal ["M4A1_RCO_GL",1];
		_currBox addWeaponCargoGlobal ["M1014",4];
		_currBox addWeaponCargoGlobal ["SCAR_L_CQC",2];
		_currBox addWeaponCargoGlobal ["SCAR_L_STD_Mk4CQT",1];
		_currBox addWeaponCargoGlobal ["M9",8];	
	...
	_currBox addMagazineCargoGlobal ["BAF_ied_v4",2];
    };
	...
	_currBox addMagazineCargoGlobal ["BAF_ied_v3",2];
    };
    ...
    case "basicSpecial3": { // Misc weapons, mostly shit
        ...
        // Add new weapons before ammunition
        _currBox addWeaponCargoGlobal ["",3];
	...
	_CurrBox addMagazineCargoGlobal ["BAF_ied_v1",2];
    };
};