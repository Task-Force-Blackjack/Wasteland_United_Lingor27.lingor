...
currentStaticBoats = []; // Storage for the boat marker numbers so that we don't spawn wrecks on top of live helis

//Civilian Vehicle List - Random Spawns
civilianVehicles = ["ARL_Kamaz3o",
					"LIN_KamazOpen",
					...
					"ibr_kamaz_adventure2",
					"ibr_blkhmw"];

//Military Vehicle List - Random Spawns
militaryVehicles = ["ibr_VAB_policia",
					"SUV_PMC",
					"ibr_VBL",
					"BAF_Offroad_W",
					"ibr_VBL_127",
...
armedMilitaryVehicles = ["ibr_offroad_spg9_arl",
